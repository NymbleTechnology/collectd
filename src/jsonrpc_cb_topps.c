...
int jsonrpc_cb_topps_get_top (struct json_object *params, struct json_object *result, const char **errorstring) /* {{{ */
{
        ...
        if(0 == json_object_object_get_ex(params, "tm", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        ...
        if(0 == json_object_object_get_ex(params, "end_tm", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        if(!json_object_is_type (obj, json_type_int)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        ...
        if(0 == json_object_object_get_ex(params, "hostname", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
...
int jsonrpc_cb_topps_get_timeline (struct json_object *params, struct json_object *result, const char **errorstring) /* {{{ */
{
        ...
        /* Params : get the "start_tm" timestamp */
        if(0 == json_object_object_get_ex(params, "start_tm", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        if(!json_object_is_type (obj, json_type_int)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        ...
        if(0 == json_object_object_get_ex(params, "interval", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        if(!json_object_is_type (obj, json_type_int)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        ...
        if(0 == json_object_object_get_ex(params, "ignore_short_lived", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        if(!json_object_is_type (obj, json_type_int)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        ...
        if(0 == json_object_object_get_ex(params, "ignore_resident", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        ...
        if(0 == json_object_object_get_ex(params, "timeout", &obj)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
        }
        if(!json_object_is_type (obj, json_type_int)) {
                return (JSONRPC_ERROR_CODE_32602_INVALID_PARAMS);
